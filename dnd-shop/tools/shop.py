...
def shop_create(
    ...
    Args:
        ...
        shop_type: Template to seed inventory — general | blacksmith | apothecary | magic | fence
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "shop_type": {"type": "string", "description": "Template: general | blacksmith | apothecary | magic | fence. Default: general"},
