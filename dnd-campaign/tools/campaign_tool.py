...
Supports multiple campaigns per Discord server. Each campaign has its own:
- World state (location, chapter, time, etc.)
- Quest log
- Party progress

Use campaign_create to start a new campaign, campaign_switch to change between them.
"""
